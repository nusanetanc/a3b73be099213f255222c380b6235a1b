...
bot.on('/hr', msg => {
  ...
  if(hrMenu == 'in') {
    ...
    function listMajors(auth) {
          ...
          values: [ ["-", telegramId, firstName+" "+lastName, dateNow, hourNow, "-", "-", "-"]]
            ...
            if (err) {
              ...
              return;
                ...
                return bot.sendMessage(msg.from.id, `Sampai datang ${firstName}, semoga hari Anda menyenangkan.`);
            }
        });
    }//end
      ...
      return bot.sendMessage('Menu HR'); //not working
  }
});
